...
public class ShadowItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    void moveIfNecessary(ViewHolder viewHolder) {
        ...
        Log.d(TAG, "x = [" + (x) + "]");
        Log.d(TAG, "y = [" + (y) + "]");
        int y_ = Math.abs(y - viewHolder.itemView.getTop());
        float h_ = viewHolder.itemView.getHeight() * threshold;
        int x_ = Math.abs(x - viewHolder.itemView.getLeft());
        float w_ = viewHolder.itemView.getWidth() * threshold;
        Log.d(TAG, "y_ = [" + (y_) + "]");
        Log.d(TAG, "x_ = [" + (x_) + "]");
        Log.d(TAG, "w_ = [" + (w_) + "]");
        Log.d(TAG, "h_ = [" + (h_) + "]");
    ...
    public abstract static class Callback implements View.OnDragListener {
         ...
         * to call its {@link View#onDragEvent(DragEvent) onDragEvent()} handler.
         */
        @Override
            ...
            if (child != null) {
                ...
                if (vh != null) {
                    ...
                    if (pointerId == mActivePointerId) {
                        ...
                        if (DEBUG) {
                            Log.d(TAG,
                                    "on long press: x:" + mInitialTouchX + ",y:" + mInitialTouchY);
                        }
